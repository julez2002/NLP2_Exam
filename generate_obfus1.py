...
OUTPUT_JSON = "qwen_generated_obfus1.json"
...
def make_generation_prompt(summary: str) -> str:
    return f"""
Write a text from the bullet points from {summary} that passes as human-authored. It will be compared to a human corpus using TF-IDF, type-token ratio, and embedding clusters. Write a text that has between 500 and 700 words. words. Stop before the tidy wrap-up sentence.
USE plain words humans actually repeat:
  people, time, way, just, new, good, said, did, know, think, day, little,
  old, world, life, like.

AVOID the AI abstract register:
  understanding, narrative, societal, cultural, individuals, significant,
  challenges, perspective, profound, fundamentally, ultimately
AVOID the AI pseudo-literary cluster — strongest tell:
  "her eyes," "his voice," "the air," "in his heart," "her mind,"
  "the words." Don't gesture at emotion through body parts and atmosphere.
REPEAT words. Don't synonymize. If it's "the car," keep it "the car" — not
"vehicle," not "sedan." AI reaches for a fresh word every sentence;
humans don't.
No opener. No symmetrical conclusion. Pick one thing, don't cover
every angle. Uneven sentence rhythm.

Output the text only. No title, no preamble. 
