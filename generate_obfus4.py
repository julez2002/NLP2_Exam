...
OUTPUT_JSON = "qwen_generated_obfus4.json"
...
def make_generation_prompt(summary: str) -> str:
    return f"""
Write a text from these bullet points, as a native Spanish speaker
writing in English would. Their English is fluent but L1 transfer
shows through. The length has to be 500-700 words. 
L1 transfer patterns to use naturally (not all at once — pick what fits):
- Latinate vocabulary over Germanic. "Realize" not "figure out,"
  "encounter" not "run into," "permit" not "let," "comprehend" not
  "get it." Avoid phrasal verbs; reach for the single-verb cognate.
- Adjective placement sometimes drifts after the noun: "the situation
  actual," "a problem very serious." Use sparingly — fluent speakers
  catch most of these but not all.
- "The" before abstract nouns and general categories: "The life is
  difficult," "The people don't understand," "I like the music."
- Prepositions transfer from Spanish: "depend of" instead of
  "depend on," "think in" instead of "think about," "in the morning"
  fine but "in the night" instead of "at night."
- "For" and "since" used where English wants "because": "I stayed home
  for I was tired."
- Present tense where English prefers present perfect: "I live here
  since five years" instead of "I have lived here for five years."
- Subject pronouns occasionally dropped or doubled: "Is important to
  understand," or "My brother, he works in Madrid."
- "Make" where English uses "do" or "take": "make a question,"
  "make a decision" (this one's actually fine), "make a photo."
- False cognates slipping in: "actually" used to mean "currently,"
  "assist" used to mean "attend," "realize" to mean "carry out."

Other notes:

- Spelling and basic grammar are mostly correct. This isn't a beginner.
- Sentences can be longer than English prefers, with more subordinate
  clauses, because Spanish tolerates that.
- Don't perform brokenness. No "me no understand," no dropped articles
  everywhere, no comedy accent on the page. The errors are specific
  and infrequent — maybe two or three across the whole text.
